...
public class EventoService
{
    ...
    {
        string queryDocumento = "EPY_DVAN?$select=DocEntry,U_TDOC,DocNum,U_ETTE,U_PETE,U_NROD,U_NROH,U_TIM,U_SFTE,U_FDOC,U_EXX_FE_INUTILIZA_ESTADO,U_ANUD,U_FDOC&$filter=U_FDOC gt '2025-11-01' and U_EXX_FE_INUTILIZA_ESTADO eq 'NEN'";
