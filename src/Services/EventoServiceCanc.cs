...
public class EventoServiceCancelacion
{
    ...
    {
        string queryDocumento = "Invoices?$select=DocEntry,DocNum,U_EXX_FE_CDC,Comments,DocumentStatus,CancelStatus&$filter=Cancelled eq 'tYES' and U_EXX_FE_Estado eq 'AUT' AND U_EXX_FE_ANULACION_ESTADO eq 'NAU' eq 'NAU' and DocDate ge '20260218'";
    ...
    {
        string queryDocumento = "CreditNotes?$select=DocEntry,DocNum,U_EXX_FE_CDC,Comments,DocumentStatus,CancelStatus&$filter=Cancelled eq 'tYES' and U_EXX_FE_Estado eq 'AUT' AND U_EXX_FE_ANULACION_ESTADO eq 'NAU'";
